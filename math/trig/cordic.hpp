...
namespace cordic
{
    ...
    /*Reduce angle to be in the range from -π to π.*/
    /*This is very important as the CORDIC algorithm*/
    /*only works in this range*/
    ...
    {
        /*Reduce the angle with the function we defined earlier*/
        /*Again, this is extremely important to maintain accuracy*/
        theta = reduce_angle(theta);
        double multiplier = 1.0;
        /*If theta falls outside the range from -π/2 to π/2,*/
        /*we reduce it even more and set multiplier to -1.*/
        /*We multiply the result by multiplier (duh), as that*/
        /*will affect the result of cordic_sin(), cordic_cos(), and cordic_tan()*/
        /*and correct them after the reduction of theta*/
        if(theta > pi_2)
        {
            theta -= pi;
            multiplier = -1.0;
